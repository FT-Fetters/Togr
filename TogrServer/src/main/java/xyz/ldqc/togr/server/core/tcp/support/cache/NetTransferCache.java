package xyz.ldqc.togr.server.core.tcp.support.cache;
...
public class NetTransferCache {
  ...
  private ConcurrentLinkedDeque<FrameEntity> frameQueue;
  ...
  private void doAppend(byte[] data){
    ...
    FrameEntity frameEntity = new FrameEntity(id, d);
  ...
  public List<FrameEntity> consume() {
    if (frameQueue.isEmpty()) {
      return Collections.emptyList();
    }
    List<FrameEntity> r = new LinkedList<>();
